#!/usr/bin/env python3
"""
Submit MoP Experimental Grid for CLIP Nano to SLURM.
"""
...
RESULTS_BASE = ROOT_DIR / "results" / "mop_grid_clip_v1"
...
# 3. Few-Shot Fine-Tuning and Eval
...
def submit():
    ...
    log_dir = ROOT_DIR / "logs" / "mop_grid_clip"
