#!/bin/bash
#SBATCH --comment=chronos_CLIP_256emb
#SBATCH --time=4320
#SBATCH --mem=20000
#SBATCH --cpus-per-task=1
#SBATCH --output=output_%j.txt
#SBATCH --error=error_output_%j.txt
#SBATCH --job-name=chronos_CLIP_256emb
...
# time python3 /home/WUR/stiva001/WUR/ssm_time_series/src/cosine_training.py --resume-checkpoint /home/WUR/stiva001/WUR/ssm_time_series/checkpoints/ts_encoder_20251126_1750
