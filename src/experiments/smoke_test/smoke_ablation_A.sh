#!/bin/bash
#SBATCH --comment=smoke_ablation_A
#SBATCH --time=120
#SBATCH --mem=16000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/smoke/ablation_A_%j.out
#SBATCH --error=logs/smoke/ablation_A_%j.err
#SBATCH --job-name=smoke_ablA
...
time python3 "${SRC}/experiments/ablation_A_mv_rp.py" \
    ...
    --results_dir "${REPO}/results/smoke/ablation_A" \
    --seed 42
