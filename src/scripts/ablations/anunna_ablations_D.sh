#!/bin/bash
#SBATCH --comment=ablation_D_visual_repr
#SBATCH --time=1440
#SBATCH --mem=32000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/ablation_D/ablation_D_%j.out
#SBATCH --error=logs/ablation_D/ablation_D_%j.err
#SBATCH --job-name=ablation_D_visual_repr
...
# Compares: rp (base), gasf, mtf, stft on ETTh1, ETTm1, Weather, Traffic, Solar
...
time python3 "${SRC}/experiments/ablation_D_visual_repr.py" \
    ...
    --train_epochs 20 \
    --probe_epochs 20 \
    --results_dir /home/WUR/stiva001/WUR/ssm_time_series/results/ablation_D \
