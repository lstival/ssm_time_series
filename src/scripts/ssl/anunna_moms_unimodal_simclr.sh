#!/bin/bash
#SBATCH --comment=moms_uni_simclr
#SBATCH --time=720
#SBATCH --mem=64000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/moms_full/uni_simclr_%j.out
#SBATCH --error=logs/moms_full/uni_simclr_%j.err
#SBATCH --job-name=moms_uni_simclr
...
ENCODER="simclr_uni"
CKPT_DIR="checkpoints/simclr_temporal/ts_simclr_temporal_lotsa_20260407_1930"
CONFIG="/home/WUR/stiva001/WUR/ssm_time_series/src/configs/lotsa_simclr_temporal.yaml"
...
echo "============================================================"
echo "MoMS Unimodal Pipeline — SimCLR Temporal (Full)"
...
EXIT_CODE=$?
echo "MoMS SimCLR-Unimodal done. Exit: ${EXIT_CODE}"
exit ${EXIT_CODE}
