#!/bin/bash
#SBATCH --comment=icml_simclr_micro_train
#SBATCH --time=720
#SBATCH --mem=32000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/icml_simclr_micro/train_%j.out
#SBATCH --error=logs/icml_simclr_micro/train_%j.err
#SBATCH --job-name=icml_simclr_m
...
echo "Training SimCLR bimodal MICRO on ICML datasets (supervised-domain baseline)"
