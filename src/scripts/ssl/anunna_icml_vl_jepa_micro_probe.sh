...
#SBATCH --output=logs/icml_vl_jepa_micro/probe_%j.out
#SBATCH --error=logs/icml_vl_jepa_micro/probe_%j.err
#SBATCH --job-name=icml_jepa_mp
...
time python3 "${SRC}/experiments/probe_lotsa_checkpoint.py" \
    ...
    --probe_epochs 20 \
    --results_dir /home/WUR/stiva001/WUR/ssm_time_series/results/icml_vl_jepa_micro \
