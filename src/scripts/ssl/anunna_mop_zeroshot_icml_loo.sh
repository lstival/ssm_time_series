#!/bin/bash
#SBATCH --comment=mop_zs_icml_loo
#SBATCH --time=720
#SBATCH --mem=48000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/mop_tuning/mop_zs_icml_loo_%j.out
#SBATCH --error=logs/mop_tuning/mop_zs_icml_loo_%j.err
#SBATCH --job-name=mop_zs_loo
...
echo "============================================================"
echo "Exp B: MoP Tuning — Leave-One-Out (true cross-dataset zero-shot)"
echo "============================================================"
