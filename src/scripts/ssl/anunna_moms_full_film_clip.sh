#!/bin/bash
#SBATCH --comment=moms_film_clip
#SBATCH --time=720
#SBATCH --mem=64000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/moms_full/film_clip_%j.out
#SBATCH --error=logs/moms_full/film_clip_%j.err
#SBATCH --job-name=moms_film_clip
...
echo "============================================================"
echo "MoMS FiLM Pipeline — CLIP-Full (Opção C)"
...
EXIT_CODE=$?
echo "MoMS FiLM CLIP done. Exit: ${EXIT_CODE}"
exit ${EXIT_CODE}
