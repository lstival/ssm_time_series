#!/bin/bash
#SBATCH --comment=moms_full_clip
#SBATCH --time=720
#SBATCH --mem=64000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/moms_full/clip_%j.out
#SBATCH --error=logs/moms_full/clip_%j.err
#SBATCH --job-name=moms_clip
...
echo "============================================================"
echo "MoMS Full Pipeline — CLIP-Full encoder"
...
EXIT_CODE=$?
echo ""
echo "MoMS CLIP pipeline done. Exit: ${EXIT_CODE}"
exit ${EXIT_CODE}
