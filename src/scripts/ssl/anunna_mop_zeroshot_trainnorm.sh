#!/bin/bash
#SBATCH --comment=mop_zeroshot_trainnorm
#SBATCH --time=180
#SBATCH --mem=48000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/mop_tuning/mop_zeroshot_trainnorm_%j.out
#SBATCH --error=logs/mop_tuning/mop_zeroshot_trainnorm_%j.err
#SBATCH --job-name=mop_zs_tnorm
...
echo "============================================================"
echo "Starting MoP Zero-Shot Probe — Train-set Normalization"
echo "MoP checkpoint: ${MOP_CHECKPOINT}"
echo "============================================================"

time python3 /home/WUR/stiva001/WUR/ssm_time_series/src/experiments/mop_zeroshot_trainnorm.py \
