#!/bin/bash
#SBATCH --comment=mop_xa_varB
#SBATCH --time=480
#SBATCH --mem=64000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/gift_eval/mop_xa_varB_%j.out
#SBATCH --error=logs/gift_eval/mop_xa_varB_%j.err
#SBATCH --job-name=xa_varB
...
# Horizon embedding concatenated to z_pool before prompt selection —
# H=96 and H=720 now get different prompt mixtures.
