#!/bin/bash
#SBATCH --comment=moms_fewshot_clip
#SBATCH --time=600
#SBATCH --mem=48000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/moms_full/fewshot_clip_%j.out
#SBATCH --error=logs/moms_full/fewshot_clip_%j.err
#SBATCH --job-name=moms_fs_clip
...
echo "============================================================"
echo "MoMS Few-Shot — CLIP-Full encoder (Stage 2 only)"
