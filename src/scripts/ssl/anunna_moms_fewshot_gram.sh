#!/bin/bash
#SBATCH --comment=moms_fewshot_gram
#SBATCH --time=600
#SBATCH --mem=48000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/moms_full/fewshot_gram_%j.out
#SBATCH --error=logs/moms_full/fewshot_gram_%j.err
#SBATCH --job-name=moms_fs_gram
...
echo "============================================================"
echo "MoMS Few-Shot — GRAM-Full encoder (Stage 2 only)"
