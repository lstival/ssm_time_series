#!/bin/bash
#SBATCH --comment=moms_fewshot_byol_film
#SBATCH --time=600
#SBATCH --mem=48000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/moms_full/fewshot_byol_film_%j.out
#SBATCH --error=logs/moms_full/fewshot_byol_film_%j.err
#SBATCH --job-name=moms_fs_byol_film
...
ENCODER="byol"
CKPT_DIR="checkpoints/byol_bimodal_full/ts_byol_bimodal_full_lotsa_20260414_171343"
CONFIG="/home/WUR/stiva001/WUR/ssm_time_series/src/configs/lotsa_byol_bimodal_full.yaml"
...
echo "============================================================"
echo "MoMS Few-Shot FiLM — BYOL-Full (Opção C: no encoder retrain)"
