#!/bin/bash
#SBATCH --comment=moms_fewshot_simclr
#SBATCH --time=600
#SBATCH --mem=48000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/moms_full/fewshot_simclr_%j.out
#SBATCH --error=logs/moms_full/fewshot_simclr_%j.err
#SBATCH --job-name=moms_fs_simclr
...
echo "============================================================"
echo "MoMS Few-Shot — SimCLR-Full encoder (Stage 2 only)"
