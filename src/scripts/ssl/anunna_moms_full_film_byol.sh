#!/bin/bash
#SBATCH --comment=moms_film_byol
#SBATCH --time=720
#SBATCH --mem=64000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/moms_full/film_byol_%j.out
#SBATCH --error=logs/moms_full/film_byol_%j.err
#SBATCH --job-name=moms_film_byol
...
echo "============================================================"
echo "MoMS FiLM Pipeline — BYOL-Full (Opção C)"
...
EXIT_CODE=$?
echo "MoMS FiLM BYOL done. Exit: ${EXIT_CODE}"
exit ${EXIT_CODE}
