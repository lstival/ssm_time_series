#!/bin/bash
#SBATCH --comment=icml_clip_nano_probe_1pct
#SBATCH --time=360
#SBATCH --mem=32000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/icml_clip_nano/probe_1pct_%j.out
#SBATCH --error=logs/icml_clip_nano/probe_1pct_%j.err
#SBATCH --job-name=icml_nano_1pct
...
echo "Few-shot 1% probe — CLIP nano ICML checkpoint: ${CHECKPOINT_DIR}"
...
time python3 "${SRC}/experiments/probe_lotsa_checkpoint.py" \
    ...
    --probe_epochs 20 \
    --results_dir /home/WUR/stiva001/WUR/ssm_time_series/results/icml_clip_nano_1pct \
