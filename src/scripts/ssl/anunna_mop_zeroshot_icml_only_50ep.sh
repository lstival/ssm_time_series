#!/bin/bash
#SBATCH --comment=mop_zs_icml_50ep
#SBATCH --time=480
#SBATCH --mem=48000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/mop_tuning/mop_zs_icml_only_50ep_%j.out
#SBATCH --error=logs/mop_tuning/mop_zs_icml_only_50ep_%j.err
#SBATCH --job-name=mop_zs_50ep
...
echo "============================================================"
echo "Exp A — 50 epochs: MoP Tuning on ICML benchmarks only"
echo "============================================================"
