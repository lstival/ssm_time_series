#!/bin/bash
#SBATCH --comment=moms_full_byol
#SBATCH --time=720
#SBATCH --mem=64000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/moms_full/byol_%j.out
#SBATCH --error=logs/moms_full/byol_%j.err
#SBATCH --job-name=moms_byol
...
echo "============================================================"
echo "MoMS Full Pipeline — BYOL-Full encoder"
...
EXIT_CODE=$?
echo ""
echo "MoMS BYOL pipeline done. Exit: ${EXIT_CODE}"
exit ${EXIT_CODE}
