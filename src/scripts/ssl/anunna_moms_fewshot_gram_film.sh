#!/bin/bash
#SBATCH --comment=moms_fewshot_gram_film
#SBATCH --time=600
#SBATCH --mem=48000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/moms_full/fewshot_gram_film_%j.out
#SBATCH --error=logs/moms_full/fewshot_gram_film_%j.err
#SBATCH --job-name=moms_fs_gram_film
...
echo "============================================================"
echo "MoMS Few-Shot FiLM — GRAM-Full (Opção C: no encoder retrain)"
