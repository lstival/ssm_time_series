#!/bin/bash
#SBATCH --comment=byol_nano_best
#SBATCH --time=2880
#SBATCH --mem=32000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/byol_nano_best/train_%j.out
#SBATCH --error=logs/byol_nano_best/train_%j.err
#SBATCH --job-name=byol_nano_best
...
echo "Starting BYOL nano best training (ablation-best settings, bimodal, combined dataset)..."
