#!/bin/bash
#SBATCH --comment=icml_clip_micro_probe
#SBATCH --time=360
#SBATCH --mem=32000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/icml_clip_micro/probe_%j.out
#SBATCH --error=logs/icml_clip_micro/probe_%j.err
#SBATCH --job-name=icml_clip_mp
...
echo "Probing CLIP micro ICML checkpoint: ${CHECKPOINT_DIR}"
...
time python3 "${SRC}/experiments/probe_lotsa_checkpoint.py" \
    ...
    --probe_epochs 20 \
    --results_dir /home/WUR/stiva001/WUR/ssm_time_series/results/icml_clip_micro \
