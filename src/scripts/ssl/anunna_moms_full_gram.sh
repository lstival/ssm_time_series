#!/bin/bash
#SBATCH --comment=moms_full_gram
#SBATCH --time=720
#SBATCH --mem=64000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/moms_full/gram_%j.out
#SBATCH --error=logs/moms_full/gram_%j.err
#SBATCH --job-name=moms_gram
...
echo "============================================================"
echo "MoMS Full Pipeline — GRAM-Full encoder"
...
EXIT_CODE=$?
echo ""
echo "MoMS GRAM pipeline done. Exit: ${EXIT_CODE}"
exit ${EXIT_CODE}
