#!/bin/bash
#SBATCH --comment=moms_film_simclr
#SBATCH --time=720
#SBATCH --mem=64000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/moms_full/film_simclr_%j.out
#SBATCH --error=logs/moms_full/film_simclr_%j.err
#SBATCH --job-name=moms_film_simclr
...
echo "============================================================"
echo "MoMS FiLM Pipeline — SIMCLR-Full (Opção C)"
...
EXIT_CODE=$?
echo "MoMS FiLM SIMCLR done. Exit: ${EXIT_CODE}"
exit ${EXIT_CODE}
