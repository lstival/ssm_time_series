...
#SBATCH --output=logs/gram/train_%j.out
#SBATCH --error=logs/gram/train_%j.err
#SBATCH --job-name=gram
...
time python3 "${SRC}/gram_training.py" --config "${SRC}/configs/lotsa_gram.yaml"
