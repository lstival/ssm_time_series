#!/bin/bash
#SBATCH --comment=moms_fewshot_byol
#SBATCH --time=600
#SBATCH --mem=48000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/moms_full/fewshot_byol_%j.out
#SBATCH --error=logs/moms_full/fewshot_byol_%j.err
#SBATCH --job-name=moms_fs_byol
...
echo "============================================================"
echo "MoMS Few-Shot — BYOL-Full encoder (Stage 2 only)"
