#!/bin/bash
#SBATCH --comment=moms_uni_clip
#SBATCH --time=720
#SBATCH --mem=64000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/moms_full/uni_clip_%j.out
#SBATCH --error=logs/moms_full/uni_clip_%j.err
#SBATCH --job-name=moms_uni_clip
...
ENCODER="clip_uni"
CKPT_DIR="checkpoints/clip_temporal/ts_clip_temporal_lotsa_20260413_104054"
CONFIG="/home/WUR/stiva001/WUR/ssm_time_series/src/configs/lotsa_clip_temporal.yaml"
...
echo "============================================================"
echo "MoMS Unimodal Pipeline — CLIP Temporal (Full)"
...
EXIT_CODE=$?
echo "MoMS CLIP-Unimodal done. Exit: ${EXIT_CODE}"
exit ${EXIT_CODE}
