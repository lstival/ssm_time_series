#!/bin/bash
#SBATCH --comment=simclr_mv_joint_train
#SBATCH --time=720
#SBATCH --mem=64000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/simclr_mv/joint_%j.out
#SBATCH --error=logs/simclr_mv/joint_%j.err
#SBATCH --job-name=mv_joint
...
echo "============================================================"
echo "Ablation MV-C: SimCLR Full — Global L2 Joint RP + FiLM fusion"
echo "rp_mv_strategy=joint | fusion_mode=film | 24h | LOTSA+Chronos"
echo "============================================================"

time python3 "${SRC}/simclr_bimodal_training.py" \
    --config "${SRC}/configs/lotsa_simclr_full_mv_joint.yaml"
