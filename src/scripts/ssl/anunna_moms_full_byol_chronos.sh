#!/bin/bash
#SBATCH --comment=moms_full_byol_chronos
#SBATCH --time=720
#SBATCH --mem=64000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/moms_full/byol_chronos_%j.out
#SBATCH --error=logs/moms_full/byol_chronos_%j.err
#SBATCH --job-name=moms_byol_ch
...
echo "============================================================"
echo "MoMS Full Pipeline — BYOL-Full + Chronos corpus"
...
EXIT_CODE=$?
echo ""
echo "MoMS BYOL+Chronos pipeline done. Exit: ${EXIT_CODE}"
exit ${EXIT_CODE}
