#!/bin/bash
#SBATCH --comment=mop_zeroshot_psn
#SBATCH --time=120
#SBATCH --mem=48000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/mop_tuning/mop_zeroshot_psn_%j.out
#SBATCH --error=logs/mop_tuning/mop_zeroshot_psn_%j.err
#SBATCH --job-name=mop_zs_psn
...
echo "============================================================"
echo "Starting MoP Zero-Shot Probe — PSN (instance normalization)"
echo "MoP checkpoint: ${MOP_CHECKPOINT}"
echo "============================================================"

time python3 /home/WUR/stiva001/WUR/ssm_time_series/src/experiments/mop_zeroshot_psn.py \
