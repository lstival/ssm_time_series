#!/bin/bash
#SBATCH --comment=moms_full_simclr_chronos
#SBATCH --time=720
#SBATCH --mem=64000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/moms_full/simclr_chronos_%j.out
#SBATCH --error=logs/moms_full/simclr_chronos_%j.err
#SBATCH --job-name=moms_simclr_ch
...
echo "============================================================"
echo "MoMS Full Pipeline — SimCLR-Full + Chronos corpus"
...
EXIT_CODE=$?
echo ""
echo "MoMS SimCLR+Chronos pipeline done. Exit: ${EXIT_CODE}"
exit ${EXIT_CODE}
