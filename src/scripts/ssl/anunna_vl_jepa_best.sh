#!/bin/bash
#SBATCH --comment=vl_jepa_best
#SBATCH --time=2880
#SBATCH --mem=32000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/vl_jepa_best/train_%j.out
#SBATCH --error=logs/vl_jepa_best/train_%j.err
#SBATCH --job-name=vl_jepa_best
