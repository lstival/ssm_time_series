#!/bin/bash
#SBATCH --comment=mop_xa_varA
#SBATCH --time=480
#SBATCH --mem=64000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/gift_eval/mop_xa_varA_%j.out
#SBATCH --error=logs/gift_eval/mop_xa_varA_%j.err
#SBATCH --job-name=xa_varA
...
# Variant A: visual encoder token prepended as extra key/value in cross-attn.
# Reintegrates the visual modality that variant D dropped.
