#!/bin/bash
#SBATCH --comment=gram_full_train
#SBATCH --time=2880
#SBATCH --mem=48000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/gram_full/train_%j.out
#SBATCH --error=logs/gram_full/train_%j.err
#SBATCH --job-name=gram_full
...
echo "Training GRAM FULL — model_dim=256, depth=8, emb=128, ctx=336"
