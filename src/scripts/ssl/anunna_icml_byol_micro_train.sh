#!/bin/bash
#SBATCH --comment=icml_byol_micro_train
#SBATCH --time=720
#SBATCH --mem=32000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/icml_byol_micro/train_%j.out
#SBATCH --error=logs/icml_byol_micro/train_%j.err
#SBATCH --job-name=icml_byol_m
...
echo "Training BYOL bimodal MICRO on ICML datasets (supervised-domain baseline)"
