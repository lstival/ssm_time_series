#!/bin/bash
#SBATCH --comment=simclr_visual_nano
#SBATCH --time=2880
#SBATCH --mem=32000
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/simclr_visual_nano/train_%j.out
#SBATCH --error=logs/simclr_visual_nano/train_%j.err
#SBATCH --job-name=simclr_v_nano
...
echo "Training SimCLR visual-only NANO (upper_tri RP) — model_dim=128, depth=4, emb=64, ctx=336"
