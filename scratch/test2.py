...
from analysis.mamba_attn_viz import extract_visual_attention, load_byol_bimodal_encoders, load_etth1, _GradSaliency
...
# Calculate standard deviation over the sequence of tokens for each batch and each feature dimension
...
# Now with linear regression logic checking
act_norm = acts.norm(dim=-1)
print("Activation norms:", act_norm[0, :10])
print("Correlation between Grad x Act saliency and pure Activation Norm:")
